...
export default function Try1() {
  ...
  // console.log(text2Ref.current.getBoundingClientRect().top);
  // useGSAP(
  //   () => {
  //     //
  //   },
        ...
        <div className="w-screen">
          ...
          >
            <defs>
              <path
                id="wavepath"
                d="M 0 2000 0 500 Q 116.5 431 233 500 t 233 0 233 0 233 0 233 0 233 0 233 0  v1000 z"
              />
